...
namespace Special_Cars
{
    class Program
    {
        ...
        {
            List<List<double>> tiresYears = new List<List<double>>();
            List<List<double>> tiresPressures  = new List<List<double>>();
            ...
            while (input != "No more tires")
            {
                ...
                tiresYears.Add(listYears);
                tiresPressures.Add(listPressures);
            ...
            while(thirdInput != "Show special")
            {
                ...
                double pressure = tires.GetSumPressure(tiresPressures, tiresIndex);
